...
namespace Aspenlaub.Net.GitHub.CSharp.Vishizhukel.Entities.Data {
    public class SecretApplicationDataFolders : ISecret<ApplicationDataFolders> {
        ...
        public ApplicationDataFolders DefaultValue => vDefaultValue ?? ( vDefaultValue = new ApplicationDataFolders { new ApplicationDataFolder { FullName = DefaultFolder, Machine = Environment.MachineName } });

        public string Guid => "67B90C8D-832C-413B-848C-B9EEC0FC6E6A";
    }
}
